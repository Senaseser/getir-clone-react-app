  ...
  return (
    <div>
      <div className="relative overflow-hidden  h-[500px] ">
        <div className="before:bg-gradient-to-r before:from-primary-brand-color before:to-transparent before:absolute before:inset-0 before:z-full before:w-full before:z-20 before:opacity-100"></div>
        ...
        <div className="container flex column justify-between items-center  absolute top-0 left-1/2 -translate-x-1/2 h-full z-30 ">
          <div>
            <img
              className="w-[180px] "
              alt=""
            ...
            <div className="grid gap-y-3">
              <div className="flex mt-4">
                ...
                <label className="flex-1 relative block">
                  <input required className="phone w-full peer text-sm pt-2" />
