...
export default function Header() {
  return (
    <header className="bg-brand-color sticky top-0 z-50 left-0 right-0 ">
      <div className="container mx-auto px-4 h-11 flex items-center justify-between ">
        ...
        <nav className="flex gap-x-8 text-sm font-semibold ">
          <a
            href="#"
            className="text-white text-opacity-80 hover:text-opacity-100 transition-all flex items-center gap-x-2"
          >
            <BiGlobe size={20} />
            Türkçe (TR)
          </a>
